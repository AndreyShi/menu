...
void CMenu::initmenu_static()
{
	...
	mDiag[0] = { 1,sDiag[0],&mDiag[9],&mDiag[1],&mAllpar[1],&mStart };
	mDiag[1] = { 2,sDiag[1],&mDiag[0],&mDiag[2],0,&mStart };
